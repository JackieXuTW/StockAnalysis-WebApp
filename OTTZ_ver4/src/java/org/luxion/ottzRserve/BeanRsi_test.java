...
public class BeanRsi_test extends BeanOTTZ_test{
    ...
    public void excute() throws RserveException, REXPMismatchException, ParseException, Exception {
        try{    
            ...
            if(checkBuysell){
                ...
                this.revenueTrade = String.valueOf(df.format(Double.parseDouble(c.eval("rsiTest$revenue").asString()))); //將字串轉為double縮至二位數之後再轉為string
    ...
    {
        return "/webimg/TA/RSI/" + this.rplotPicName + ".png";
    }  
