...
<html>
    ...
    <body>  
        ...
        <sql:query var="rs" dataSource="jdbc/ottzDB" scope="page">
            SELECT * FROM [ottzDB].[dbo].[MATrain] ORDER BY createTime DESC
        </sql:query>
        ...
        <table class="showTable">
            ...
            <c:forEach var="row" items="${rs.rows}">
                <tr>
                    ...
                    <td>
                        <a href="../OperatorDBMA_servlet?action=deleteMaTrain&id=${row['dataKey']}" onclick='return confirm("確定刪除此筆記錄?")'>刪除</a>
                    </td>
                    <td>
                        <a href='../testing/maTesting_yahoofinance.jsp?sendMA=true&bestS=${row['bestS']}&bestL=${row['bestL']}&testStockSymbol=${row['StockSymbol']}'>測試參數</a>
                    </td>
                </tr>
            </c:forEach>
        </table>
