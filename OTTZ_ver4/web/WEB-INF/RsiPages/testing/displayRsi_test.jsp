...
<html>
    ...
    <body>        
        ...
        <h1 align="center">RSI Testing</h1>   
        ...
        <div id="Rplot_filterTest">
            ...
            <script type="text/javascript">
                function changeImg(){
                    document.images['img1'].src="${RplotUrl}"; // remove ${pageContext.request.contextPath} by YaTing
                     }
            </script>
        </div>
                     
        <form action="OperatorDBRSI_servlet" method="post">
            <input type='hidden' name='action' value='addRsiTest'/>
